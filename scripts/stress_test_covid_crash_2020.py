"""Run a TDT-RM V5.1.4 COVID-crash 2020 TAIEX stress test.
...
def main() -> None:
    ...
    parser.add_argument("--output", default="outputs/tdt_rm_v5_1_4_2020_covid_crash_stress.csv")
    parser.add_argument("--summary", default="outputs/tdt_rm_v5_1_4_2020_covid_crash_summary.json")

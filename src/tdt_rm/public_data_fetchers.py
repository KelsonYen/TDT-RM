...
def _parse_t86_foreign_flow(payload: Any, as_of: date) -> dict[str, Any] | None:
    ...
    foreign_spot_net_buy = max(total_net, 0.0)
    foreign_spot_net_sell = abs(min(total_net, 0.0))
    return {"date": as_of.isoformat(), "foreign_spot_net_buy": foreign_spot_net_buy, "foreign_spot_net_sell": foreign_spot_net_sell, "foreign_spot_large_sell": total_net <= -10_000_000_000, "foreign_large_sell": total_net <= -10_000_000_000, "futures_hedging_increases": False, "futures_hedging_significant": False}

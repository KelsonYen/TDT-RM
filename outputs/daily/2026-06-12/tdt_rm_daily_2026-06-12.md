...
Crash Probability：22.8%
股票曝險上限：60–80%

■ 核心結論
１、MHS偏熱，代表市場情緒與價格動能偏熱；這是過熱提醒，不等於崩盤訊號。
２、TCWRS仍低，代表目前結構性破壞尚未明確出現。
３、ETI-5為0，僅有早期警訊，表示風險尚未全面落地。
４、MHS 升高代表情緒與動能偏熱，需搭配 TCWRS、ETI-5 與 Tail Risk 判讀，不可單獨解讀為崩盤風險。
５、Tail Risk 已進入高風險區，需等待其他風控指標共同確認是否升燈。
...
Trigger Evidence:
Foreign Net Sell Consecutive Days = 0
...
Trigger Evidence:
USD/TWD 3D Change = 0.16149461684611127%
Threshold: > 0.5%
USD/TWD 5D Change = 0.543547361729178%
Threshold: > 1.0%
...
Status: NOT_TRIGGERED
Source: breadth_csv
Matched Rule: breadth deterioration confirmation not triggered
Trigger Evidence:
Advancing Issues = 9333
Declining Issues = 2154
Index Down = False
Declining Issues > Advancing Issues = False
...
Raw Inputs
{
  "taiex_return_pct": 2.3629032669238543,
  "advancing_issues": 9333,
  "declining_issues": 2154,
  "breadth_history": [
    {
...
Source: ["taiex_price"]
Trigger Evidence:
one_day_return_pct: 2.3629032669238543
return_60d_pct: 30.536398931688403
result: TRACE_ONLY_NO_SUBCOMPONENT_SCORER
V_MHS
Score: 資料不足
Source: ["taiex_price"]
Trigger Evidence:
turnover_amount: 1169186958350
result: TRACE_ONLY_NO_SUBCOMPONENT_SCORER
M_MHS
Score: 資料不足
Source: ["taiex_price"]
Trigger Evidence:
ma20: 43568.718499999995
ma60: 39157.441333333336
ma20_slope: 149.83399999999529
result: TRACE_ONLY_NO_SUBCOMPONENT_SCORER
VAL_MHS
Score: 資料不足
Source: []

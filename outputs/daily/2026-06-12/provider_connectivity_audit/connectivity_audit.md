...
- Generated at: `2026-06-12T12:42:59Z`
- Probe as-of date: `2026-06-12`
...
| FinMind API | vendor Taiwan market metadata/sample | `True` | `False` | `True` | `True` | `200` | `False` | `False` | Provider authentication not tested: token required for production fallback and FINMIND_TOKEN/FINMIND_API_TOKEN is absent; not counted as provider failure |
...
- Observed failure categories: `Provider authentication not tested: token required for production fallback and FINMIND_TOKEN/FINMIND_API_TOKEN is absent; not counted as provider failure, Provider schema / API failure`
